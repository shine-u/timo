...
public class HeapUtils {
     ...
     * @param j    位置2
     */
    private static void replace(Integer[] data, int i, int j) {
        if (i == j) {
            return;
        }
        Integer temp = data[i];
...
//            print(data);
     ...
     */
    private static void createMindHeap(Integer[] data, int lastIndex) {
        //从最后一个节点作为左节点的树开始
    ...
    public static Integer[] getMaxNumber(int count, Integer[] data) {
        Integer[] maxNubmerArr = new Integer[count];
...
//                 print(maxNubmerArr);
    ...
    public static void main(String[] args) {
        ...
        for (int i=0;i<1000000000;i++){
            ...
            Integer v= random.nextInt(1000000000);
            arr[i]=v;
        }
        Integer[] maxNumber = HeapUtils.getMaxNumber(100, arr);
