...
public class Const {
    ...
    /**文件服务器地址.*/
    public static final String FILE_SERVER_PATH = "http://www.shineyu.com.cn/";
    /**文件地址.*/
    public static final String FILE_PATH = "/opt/files";
    public static final String FTP_IP = "121.40.94.59";
    public static final Integer PORT_ = 21;
    public static final String FTP_USER = "shine";
    public static final String FTP_PASS = "Shine_2019";
